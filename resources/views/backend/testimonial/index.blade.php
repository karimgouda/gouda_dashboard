...
@section('breadcrumb')
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ translate('testimonial') }}</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    <div class="widget row mt-5 mb-5 d-flex">
        <h4 class="col-6">{{ translate('testimonial') }}</h4>
        <div class="col-6 text-end">
            <a href="{{ route('testimonial.create') }}" class="btn btn-primary  ">{{ translate('add_new_testimonial') }}</a>
        </div>
    </div>
